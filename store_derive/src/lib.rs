...
pub fn derive_store(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        alloc_store_traits::macros::__impl_store!(#name);
    };
...
pub fn derive_store_dangling(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        alloc_store_traits::macros::__impl_store_dangling!(#name);
    };
    TokenStream::from(expanded)
}
...
pub fn derive_store_stable(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        alloc_store_traits::macros::__impl_store_stable!(#name);
    };
    TokenStream::from(expanded)
}
...
pub fn derive_store_no_op_resolve(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        alloc_store_traits::macros::__impl_store_no_op_resolve!(#name);
    };
    TokenStream::from(expanded)
}
...
pub fn derive_store_pinning(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        alloc_store_traits::macros::__impl_store_pinning!(#name);
    };
    TokenStream::from(expanded)
}
